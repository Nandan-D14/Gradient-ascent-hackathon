		...
		<div className="max-w-4xl mx-auto p-8">
			...
			<div className="space-y-12">
							...
							<button 
								...
								className={`px-3 py-1.5 rounded-md text-sm font-medium transition-all ${
									theme === 'light' 
										...
										: 'text-neutral-600  hover:text-neutral-800 :text-neutral-200'
								}`}
							>
				...
				<section>
					...
					<div className="flex items-center justify-between hover:bg-neutral-100 :bg-neutral-800 p-4 -m-4 rounded-lg cursor-pointer">
						<div>
				...
				<section>
					...
					<div className="mt-4 flex items-center justify-between hover:bg-neutral-100 :bg-neutral-800 p-4 -m-4 rounded-lg cursor-pointer">
						<div>
